...
library(ggplot2)
ggplot() +
  geom_line(data = stochastic_output, aes(x=time,y=n_detect_730_3650/n_730_3650, col = "Stochastic", group = particle)) +
  geom_line(data = seasonal_output, aes(x=time,y=n_detect_730_3650/n_730_3650, col = "Deterministic"),lwd=1) +
  labs(x="Time",y=bquote(italic(Pf)~PR[2-10]), col = "Simulation") +
  theme_bw()
```
