...
**Note**: tsd, het_brackets and lag_rates are fairly optimally set in the defaults, and increasing their resolution will likely increase runtime for limited accuracy gains. If you are looking to more closely approximate `malariasimulation`, the first attempt should be to increase resolution of the age_vector.  
