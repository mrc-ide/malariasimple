...
* *'Cohort' distribution* 
Assumes doses are given in cohorts. If a child receives SMC on the first distribution event, they will continue to receive further doses unless the coverage decreases. Equivalent to correlation = 1. 
